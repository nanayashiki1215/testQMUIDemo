...
//               jsStartString = [NSString stringWithFormat:@"var obj = {'token': '%@','baseurl':'%@','fsubID':'%@','ipAddress':'%@','fmenuId':'%@','userID':'%@','languageType':'%@','isOpenTrack':'%@'}; obj = JSON.stringify(obj); localStorage.setItem('energyToken',obj);",self.energyToken,user.energyDns,user.fsubID,ipAddress,self.menuId,user.bguserId,languageType,isOpenTrack];
                jsStartString = [NSString stringWithFormat:@"var obj = {'token': '%@','baseurl':'%@','fsubID':'%@','ipAddress':'%@','fmenuId':'%@','userID':'%@','languageType':'%@','isOpenTrack':'%@','energyToken':'%@','energyBaseurl':'%@','appId':'%@','serviceId':'%d'}; obj = JSON.stringify(obj); localStorage.setItem('accessToken',obj);",user.token,baseUrl,user.fsubID,ipAddress,self.menuId,user.bguserId,languageType,isOpenTrack,self.energyToken,user.energyDns,BGVersionNo,BGSERVICEID];
            }else{
                [MBProgressHUD showError:@"获取能耗Token异常"];
            }
        }else if (self.menuId.length>0) {
           jsStartString = [NSString stringWithFormat:@"var obj = {'token': '%@','baseurl':'%@','fsubID':'%@','ipAddress':'%@','fmenuId':'%@','userID':'%@','languageType':'%@','isOpenTrack':'%@','appId':'%@','serviceId':'%d'}; obj = JSON.stringify(obj); localStorage.setItem('accessToken',obj);",user.token,baseUrl,user.fsubID,ipAddress,self.menuId,user.bguserId,languageType,isOpenTrack,BGVersionNo,BGSERVICEID];
        }else{
            jsStartString = [NSString stringWithFormat:@"var obj = {'token': '%@','baseurl':'%@','fsubID':'%@','ipAddress':'%@','userID':'%@','languageType':'%@','isOpenTrack':'%@','isOpenBoxInApp':'%d','alwaysUploadPosition':'%d','appId':'%@','serviceId':'%d'}; obj = JSON.stringify(obj); localStorage.setItem('accessToken',obj);",user.token,baseUrl,user.fsubID,ipAddress,user.bguserId,languageType,isOpenTrack,openBoxInApp,alwaysUploadPosition,BGVersionNo,BGSERVICEID];
        }
        //用于进行JavaScript注入
