...
@interface CSFileManage : NSObject

//- (void)getLocalFilePath:(NSString *)onlineFilePath sessionId:(NSString *)sessionId completionHandler:(void(^)(NSString *))competion;
...
/**
 ...
 @param onlineFilePath onlineurl
 @param sessionId 后缀mp3、MP4、txt
 @param willDownload 下载
 @param competion 完成
 */
