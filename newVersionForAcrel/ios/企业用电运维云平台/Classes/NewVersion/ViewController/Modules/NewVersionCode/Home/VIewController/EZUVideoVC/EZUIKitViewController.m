...
//    self.playBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width-80)/2, [UIScreen mainScreen].bounds.size.height - 100, 80, 40);
    self.playBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width)/2-100, [UIScreen mainScreen].bounds.size.height/2 , 40, 40);
    [self.playBtn addTarget:self action:@selector(playBtnClick:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:self.playBtn];
    
    self.playBackBtn = [UIButton buttonWithType:UIButtonTypeSystem];
    [self.playBackBtn setTitle:@"回放" forState:UIControlStateNormal];
    //    self.playBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width-80)/2, [UIScreen mainScreen].bounds.size.height - 100, 80, 40);
    self.playBackBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width)/2+100, [UIScreen mainScreen].bounds.size.height/2 , 40, 40);
...
//        self.mPlayerOther.previewView.frame = CGRectMake(0, 65,
