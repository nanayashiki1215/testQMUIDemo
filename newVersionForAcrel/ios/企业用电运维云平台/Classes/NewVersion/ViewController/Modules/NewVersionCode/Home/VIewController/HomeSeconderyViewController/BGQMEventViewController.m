...
static NSString * const kCellIdentifier = @"BGEventDynamiccell";

@interface BGQMEventViewController ()<QMUITableViewDelegate,QMUITableViewDataSource>
@property (nonatomic,strong) QMUITableView *eventTableView;

@property(nonatomic, strong) QMUIOrderedDictionary *dataSource;

@end

@implementation BGQMEventViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.eventTableView = [[QMUITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
//    [self.eventTableView registerNib:[UINib nibWithNibName:@"BGQMEventTableViewCell" bundle:nil] forCellReuseIdentifier:@"kBGQMEventTableViewCell"];
    self.eventTableView.delegate = self;
    self.eventTableView.dataSource = self;
    self.eventTableView.backgroundColor = COLOR_BACKGROUND;
    ...
    self.eventTableView.qmui_cacheCellHeightByKeyAutomatically = YES;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BGQMEventDynamicTableViewCell *cell = (BGQMEventDynamicTableViewCell *)[tableView dequeueReusableCellWithIdentifier:kCellIdentifier];
    if (!cell) {
        cell = [[BGQMEventDynamicTableViewCell alloc] initForTableView:tableView withReuseIdentifier:kCellIdentifier];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self.eventTableView qmui_clearsSelection];
