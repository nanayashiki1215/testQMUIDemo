...
- (void)saveToAlbum:(CDVInvokedUrlCommand*)command{
    ...
    NSString *filePathStr = [command argumentAtIndex:0];
    NSString *filePath = [filePathStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
...
- (void)download:(CDVInvokedUrlCommand*)command
{
    ...
    NSString* source = [command argumentAtIndex:0];
    NSString* targetStr = [command argumentAtIndex:1];
    NSString *target = [targetStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
