...
- (void)initSubviews {
    ...
    UITabBarItem *item1 = [QDUIHelper tabBarItemWithTitle:NSLocalizedString(@"Home",nil) image:[UIImageMake(@"icon_tabbar_uikit") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_uikit_selected") tag:0];
    item1.qmui_doubleTapBlock = tabBarItemDoubleTapBlock;
    
    UITabBarItem *item2 = [QDUIHelper tabBarItemWithTitle:NSLocalizedString(@"Alarm",nil) image:[UIImageMake(@"icon_tabbar_component") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_component_selected") tag:1];
    item2.qmui_doubleTapBlock = tabBarItemDoubleTapBlock;
    
    UITabBarItem *item3 = [QDUIHelper tabBarItemWithTitle:NSLocalizedString(@"Electric",nil) image:[UIImageMake(@"icon_tabbar_lab") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_lab_selected") tag:2];
    item3.qmui_doubleTapBlock = tabBarItemDoubleTapBlock;
    
    UITabBarItem *item4 = [QDUIHelper tabBarItemWithTitle:NSLocalizedString(@"Inspect",nil) image:[UIImageMake(@"icon_tabbar_uikit") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_uikit_selected") tag:3];
    item4.qmui_doubleTapBlock = tabBarItemDoubleTapBlock;
    
    UITabBarItem *item5 = [QDUIHelper tabBarItemWithTitle:NSLocalizedString(@"About",nil) image:[UIImageMake(@"icon_tabbar_component") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_component_selected") tag:4];
    item5.qmui_doubleTapBlock = tabBarItemDoubleTapBlock;
