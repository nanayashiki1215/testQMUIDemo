...
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cIrEnMz';
	this._flag_='7d5413376c384323865c49a4d1cef984';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"userid":{"define":"userid","label":"userid","name":"userid","relation":"userid","type":"String"},"username":{"define":"username","label":"username","name":"username","relation":"username","type":"String"}},"directDelete":false,"events":{},"idColumn":"userid","isMain":false,"limit":20,"xid":"userdata"});
}}); 
return __result;});
