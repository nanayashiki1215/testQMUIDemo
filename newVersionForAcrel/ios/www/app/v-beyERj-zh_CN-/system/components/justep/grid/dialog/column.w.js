...
var __parent0=require('$model/UI2/system/components/justep/grid/dialog/column'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='ciYRR3y';
	this._flag_='66694f9aae1152153996725e10f2fef8';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":false,"autoNew":false,"confirmDelete":false,"confirmRefresh":false,"defCols":{"displayName":{"define":"displayName","label":"列名","name":"displayName","relation":"displayName","type":"String"},"name":{"define":"name","label":"列","name":"name","relation":"name","type":"String"},"selected":{"define":"selected","label":"选中","name":"selected","relation":"selected","type":"Boolean"}},"directDelete":false,"events":{"onCustomRefresh":"dataCustomRefresh"},"idColumn":"name","isMain":false,"limit":20,"xid":"data"});
}}); 
return __result;});
