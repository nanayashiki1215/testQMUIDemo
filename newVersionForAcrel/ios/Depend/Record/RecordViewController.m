...
- (void)onDownload:(UIButton*)sender
{
    ...
    //NSString* infoPath = [downloadDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@_download_%@", time, (m_recordType == CloudRecord) ? recId : @"device_record"]];
