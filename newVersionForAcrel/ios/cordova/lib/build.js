        ...
        .then(function (devices) {
            ...
            return spawn('rm', [ '-rf', buildOutputDir ], projectPath)
                .then(function () {
                    ...
                    //console.log("******xcodebuildArgs = " + xcodebuildArgs);
            ...
            var exportOptions = {'compileBitcode': false, 'method': 'development', 'signingStyle':'automatic', 'stripSwiftSymbols':true, 'uploadSymbols':true};
            ...
            function packageArchive () {
                ...
                //console.log("----xcodearchiveArgs = " + xcodearchiveArgs);
